...
public class CustomPreferences_bak {

	private static CustomPreferences_bak mCustomPref = new CustomPreferences_bak();
	private static CustomLogging mLog = null;
	
	private Preferences mPrefs = null;
	private String _fileLocation = "";
	
	private CustomPreferences_bak(){} //make sure this class cannot be instantiate
	
	public static CustomPreferences_bak getInstance(){
		return mCustomPref;
	}
